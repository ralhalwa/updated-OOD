...
namespace HappyJourneyCompnay {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class FlightDataTable : global::System.Data.TypedTableBase<FlightRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public FlightRow AddFlightRow(System.DateTime departure_Time, System.DateTime arrival_Time, decimal price, int destination_Id) {
...
namespace HappyJourneyCompnay.Database1DataSetTableAdapters {
    ...
    public partial class FlightTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Flight] WHERE (([flight_Id] = @Original_flight_Id) AND ([departure_Time] = @Original_departure_Time) AND ((@IsNull_arrival_Time = 1 AND [arrival_Time] IS NULL) OR ([arrival_Time] = @Original_arrival_Time)) AND ([price] = @Original_price) AND ([destination_Id] = @Original_destination_Id))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Flight] ([departure_Time], [arrival_Time], [price], [destination_Id]) VALUES (@departure_Time, @arrival_Time, @price, @destination_Id);
SELECT flight_Id, departure_Time, arrival_Time, price, destination_Id FROM Flight WHERE (flight_Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Flight] SET [departure_Time] = @departure_Time, [arrival_Time] = @arrival_Time, [price] = @price, [destination_Id] = @destination_Id WHERE (([flight_Id] = @Original_flight_Id) AND ([departure_Time] = @Original_departure_Time) AND ((@IsNull_arrival_Time = 1 AND [arrival_Time] IS NULL) OR ([arrival_Time] = @Original_arrival_Time)) AND ([price] = @Original_price) AND ([destination_Id] = @Original_destination_Id));
SELECT flight_Id, departure_Time, arrival_Time, price, destination_Id FROM Flight WHERE (flight_Id = @flight_Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HappyJourneyCompnay.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT flight_Id, departure_Time, arrival_Time, price, destination_Id FROM dbo.Fl" +
                "ight";
        ...
        public virtual int Delete(int Original_flight_Id, System.DateTime Original_departure_Time, global::System.Nullable<global::System.DateTime> Original_arrival_Time, decimal Original_price, int Original_destination_Id) {
            ...
            if ((Original_arrival_Time.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((System.DateTime)(Original_arrival_Time.Value));
            }
            else {
        ...
        public virtual int Insert(System.DateTime departure_Time, global::System.Nullable<global::System.DateTime> arrival_Time, decimal price, int destination_Id) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((System.DateTime)(departure_Time));
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(destination_Id));
        ...
        public virtual int Update(System.DateTime departure_Time, global::System.Nullable<global::System.DateTime> arrival_Time, decimal price, int destination_Id, int Original_flight_Id, System.DateTime Original_departure_Time, global::System.Nullable<global::System.DateTime> Original_arrival_Time, decimal Original_price, int Original_destination_Id, int flight_Id) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((System.DateTime)(departure_Time));
            if ((arrival_Time.HasValue == true)) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((System.DateTime)(Original_departure_Time));
            if ((Original_arrival_Time.HasValue == true)) {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_destination_Id));
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(flight_Id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime departure_Time, global::System.Nullable<global::System.DateTime> arrival_Time, decimal price, int destination_Id, int Original_flight_Id, System.DateTime Original_departure_Time, global::System.Nullable<global::System.DateTime> Original_arrival_Time, decimal Original_price, int Original_destination_Id) {
            return this.Update(departure_Time, arrival_Time, price, destination_Id, Original_flight_Id, Original_departure_Time, Original_arrival_Time, Original_price, Original_destination_Id, Original_flight_Id);
        }
    }
