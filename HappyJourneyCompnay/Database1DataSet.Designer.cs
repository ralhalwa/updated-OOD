...
namespace HappyJourneyCompnay {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserRow AddUserRow(string user_Type, string userName, string firstName, string LastName, string Email, string password, int user_Type_Id) {
        ...
        public partial class UserRow : global::System.Data.DataRow {
            ...
            public int user_Type_Id {
                get {
                    try {
                        return ((int)(this[this.tableUser.user_Type_IdColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace HappyJourneyCompnay.Database1DataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[User] WHERE (([user_Id] = @Original_user_Id) AND ((@IsNull_user_Type = 1 AND [user_Type] IS NULL) OR ([user_Type] = @Original_user_Type)) AND ((@IsNull_userName = 1 AND [userName] IS NULL) OR ([userName] = @Original_userName)) AND ((@IsNull_firstName = 1 AND [firstName] IS NULL) OR ([firstName] = @Original_firstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_user_Type_Id = 1 AND [user_Type_Id] IS NULL) OR ([user_Type_Id] = @Original_user_Type_Id)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[User] ([user_Type], [userName], [firstName], [LastName], [Email], [password], [user_Type_Id]) VALUES (@user_Type, @userName, @firstName, @LastName, @Email, @password, @user_Type_Id);
SELECT user_Id, user_Type, userName, firstName, LastName, Email, password, user_Type_Id FROM [User] WHERE (user_Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [user_Type] = @user_Type, [userName] = @userName, [firstName] = @firstName, [LastName] = @LastName, [Email] = @Email, [password] = @password, [user_Type_Id] = @user_Type_Id WHERE (([user_Id] = @Original_user_Id) AND ((@IsNull_user_Type = 1 AND [user_Type] IS NULL) OR ([user_Type] = @Original_user_Type)) AND ((@IsNull_userName = 1 AND [userName] IS NULL) OR ([userName] = @Original_userName)) AND ((@IsNull_firstName = 1 AND [firstName] IS NULL) OR ([firstName] = @Original_firstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_user_Type_Id = 1 AND [user_Type_Id] IS NULL) OR ([user_Type_Id] = @Original_user_Type_Id)));
SELECT user_Id, user_Type, userName, firstName, LastName, Email, password, user_Type_Id FROM [User] WHERE (user_Id = @user_Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT user_Id, user_Type, userName, firstName, LastName, Email, password, user_T" +
                "ype_Id FROM dbo.[User]";
        ...
        public virtual int Delete(int Original_user_Id, string Original_user_Type, string Original_userName, string Original_firstName, string Original_LastName, string Original_Email, string Original_password, global::System.Nullable<int> Original_user_Type_Id) {
            ...
            if ((Original_user_Type_Id.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[14].Value = ((int)(Original_user_Type_Id.Value));
            }
            else {
        ...
        public virtual int Insert(string user_Type, string userName, string firstName, string LastName, string Email, string password, global::System.Nullable<int> user_Type_Id) {
            if ((user_Type == null)) {
            ...
            if ((user_Type_Id.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[6].Value = ((int)(user_Type_Id.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<int> Original_user_Type_Id, 
                    int user_Id) {
            if ((user_Type == null)) {
            ...
            if ((user_Type_Id.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(user_Type_Id.Value));
            }
            else {
            ...
            if ((Original_user_Type_Id.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((int)(Original_user_Type_Id.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string user_Type, string userName, string firstName, string LastName, string Email, string password, global::System.Nullable<int> user_Type_Id, int Original_user_Id, string Original_user_Type, string Original_userName, string Original_firstName, string Original_LastName, string Original_Email, string Original_password, global::System.Nullable<int> Original_user_Type_Id) {
            return this.Update(user_Type, userName, firstName, LastName, Email, password, user_Type_Id, Original_user_Id, Original_user_Type, Original_userName, Original_firstName, Original_LastName, Original_Email, Original_password, Original_user_Type_Id, Original_user_Id);
        }
    }
